		...
		if (editorPart instanceof ITextEditor) {
			...
			if (editorPart instanceof ITextEditor) {
				...
				try {
					...
					content = "<ol start='1' style='margin-left: 0;'>" +  content.replaceAll("<p class=default>", "<li style=\"padding-left: 10px; border-left: 1px solid #D1D7DC; margin: 0 0 0 38px;\">").replaceAll("</p>", "</li>") + "</ol>";
					
					BlogProvider blogProvider = BlogProvider.getBlogProvider(defaultAccount.getAccountType());
