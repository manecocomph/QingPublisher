...
public class BlogWordpress extends BlogProvider {
	ILog log = Activator.getDefault().getLog();
	
	public void asyncGetCategories(final Display display, Account account, final Combo categoriesCombo) throws Exception {
	...
	private String getBlogLink(final Account account, final String postId) throws Exception {
		XmlRpcClient client = null;
		try {
			client = new XmlRpcClient();
			XmlRpcClientConfigImpl pConfig = new XmlRpcClientConfigImpl();
